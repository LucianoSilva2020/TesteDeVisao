let imgSVGAstigmatism = `<svg width="335" height="177.5" ><g transform="translate(-707 -1705.5)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="translate(-482 -1705.5)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(22.5 4808.063 -756.916)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(45 2579.72 166.825)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(90 1373.75 666.75)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(67.5 1797.23 491.2)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(-22.5 -3878.565 2231.839)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(-45 -1650.221 1602.077)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g><g transform="rotate(-67.5 -867.731 1380.931)"><rect width="110" height="4" transform="translate(707 1879)"></rect><rect width="110" height="4" transform="translate(707 1871)"></rect><rect width="110" height="4" transform="translate(707 1863)"></rect></g></svg>`



function startAstigmatism(test){
    if(!didTutorial){
        tutorial(test, "astigmatism")
        return
    }
    if(1 > roundsPlayed){
        starRoundsAstigmatism(test)
        roundsPlayed++
    } else {
        if(testEye == 0){
            $("#staticEye").innerHTML = ""
            ...
            $("main").innerHTML =`
                <div class="containerResult">
                    <div class="titleResult">
                        <img src="./src/imagens/astigmatism-test.svg">
                        <h2>Astigmatismo</h2>
                    </div>
...
function testNexeEyeAstigmatism(test){
    testEye = 1
    roundsPlayed = 0
    startAstigmatism(test)
}
function starRoundsAstigmatism(test){
    $("#staticEye").innerHTML = `
...
`
    $("main").innerHTML =`
        <div id="question">
            ...
            <p>Concentre-se no centro do semicírculo e responda à pergunta.</p>
            <h3>As linhas parecem ter todas o mesmo tom de preto?<h3>
            </div>
        </div>
        <div id="inputs">
            <input class="aswer-btn" type="button" value="Sim">
            <input class="aswer-btn" type="button" value="Não">
        </div>
    `
